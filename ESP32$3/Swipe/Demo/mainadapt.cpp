...
// Include SquareLine-generated UI
...
void Lvgl_GForce_Loop()
{
    ...
    // ---------------- Numeric Labels ----------------
    lv_label_set_text_fmt(ui_label_accel, "Accel: %d", (int)max(y/9.81*10,0));
    lv_label_set_text_fmt(ui_label_brake, "Brake: %d", (int)abs(min(y/9.81*10,0)));
    lv_label_set_text_fmt(ui_label_left, "Left: %d", (int)abs(min(x/9.81*10,0)));
    lv_label_set_text_fmt(ui_label_right, "Right: %d", (int)max(x/9.81*10,0));
}
